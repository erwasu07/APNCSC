...
function initDb() {
  ...
  if (!fs.existsSync(DB_PATH)) {
    const defaultDb: DatabaseSchema = {
      settings: {
        cafeName: "Apex Digital Cyber Cafe & SBI CSP",
        phone: "+91 98765 43210",
        whatsapp: "+91 98765 43210",
        email: "contact@apexdigitalcafe.com",
        ...
        seoTitle: "Apex Digital Cyber Cafe | Authorized CSC & SBI CSP Banking Center",
        seoDescription: "Authorized CSC E-Governance and SBI CSP Banking Services. Apply for PAN, Aadhaar updates, Ayushman Bharat card, Voter ID, and manage all your digital printing, GST, and business registrations in Sector 15, New Delhi.",
        seoKeywords: "cyber cafe, CSC center, SBI CSP, banking kiosk, PAN card application, Aadhaar update, online form filling, printing, photocopy, GST return, MSME registration"
      },
      announcements: [
        {
          "id": "ann-1",
