...
const FALLBACK_SETTINGS: WebsiteSettings = {
  ...
  seoTitle: "APNACSC Digital Cyber Cafe | Authorized CSC Center",
  ...
  seoKeywords: "cyber cafe, CSC center, PAN card application, Aadhaar update, online form filling, printing, photocopy, GST return, MSME registration"
};
